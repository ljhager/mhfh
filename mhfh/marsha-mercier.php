...
$userQuery = 'SELECT vs_preferred_name, vs_first_name, vs_middle_name, vs_suffix, vs_birth_date, vs_death_date FROM vital_stats WHERE vs_preferred_name = "Marsha"';  // must use double quotes on name
